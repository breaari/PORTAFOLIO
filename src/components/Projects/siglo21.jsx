...
export const Siglo21 = () => {
    return (
        <div className="bg-azuloscuro rounded-md my-6 flex flex-row justify-center items-center text-center shadow-md border-4 border-azuloscuro ">
            <img src={siglo21} className="w-[500px] h-auto objet-cover rounded-tl-md rounded-bl-md"></img>
            <div className="p-6 flex flex-col justify-center ">
                <h1 className="text-blanco text-3xl">LANDING PAGE UNIVERSITARIA</h1> 
                <p className="text-celesteclaro text-2xl">LANDING PAGE DINÁMICA PARA LOS CENTROS DE APRENDIZAJE UNIVERSITARIOS DE LA COSTA ATLÁNTICA DE LA UNIVERSIDAD SIGLO 21, CON UN FORMULARIO DE CONTACTO AUTOMATIZADO COMO LLAMADA A LA ACCIÓN.
                </p>
