    ...
    return (
        <div className="bg-azuloscuro rounded-md my-6 flex flex-row mq1220:flex-col justify-center items-center text-center shadow-md border-4 border-azuloscuro ">
            <div className="min-w-[500px] h-auto relative ">
              <img
                src={fitness}
                className={`w-[500px] mq1220:rounded-bl-none mq1220:rounded-tl-none h-auto object-cover rounded-tl-md rounded-bl-md transition-opacity duration-300 ease-in-out ${hovered ? "opacity-20" : "opacity-100"}`}
